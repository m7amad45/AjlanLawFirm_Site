...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-10 pb-16 md:pt-12 md:pb-20 bg-navy-deep">
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-muted-foreground text-lg">{t("contact_subtitle")}</p>
        </div>

        <div className="grid lg:grid-cols-5 gap-10">
          <form onSubmit={onSubmit} className="lg:col-span-3 bg-card p-8 md:p-10 shadow-luxury border border-gold/15">
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <Label htmlFor="name" className="text-xs uppercase tracking-wider text-gold mb-2 block">
                  {t("contact_name")}
                </Label>
                <Input id="name" required className="rounded-none border-border h-12 focus-visible:ring-gold" />
              </div>
              <div>
                <Label htmlFor="email" className="text-xs uppercase tracking-wider text-gold mb-2 block">
                  {t("contact_email")}
                </Label>
                <Input id="email" type="email" required className="rounded-none border-border h-12 focus-visible:ring-gold" />
              </div>
              <div>
                <Label htmlFor="phone" className="text-xs uppercase tracking-wider text-gold mb-2 block">
                  {t("contact_phone")}
                </Label>
                <Input id="phone" className="rounded-none border-border h-12 focus-visible:ring-gold" />
              </div>
              <div>
                <Label htmlFor="subject" className="text-xs uppercase tracking-wider text-gold mb-2 block">
                  {t("contact_subject")}
                </Label>
                <Input id="subject" className="rounded-none border-border h-12 focus-visible:ring-gold" />
              </div>
            </div>
            <div className="mt-5">
              <Label htmlFor="message" className="text-xs uppercase tracking-wider text-gold mb-2 block">
                {t("contact_message")}
              </Label>
              <Textarea id="message" rows={5} required className="rounded-none border-border focus-visible:ring-gold" />
            </div>
              ...
              <ul className="space-y-6">
                {info.map((i) => (
                  <li key={i.label} className="flex gap-4">
                    ...
                    <div>
                      <div className="text-gold uppercase tracking-wider text-[10px] font-medium mb-1">{i.label}</div>
